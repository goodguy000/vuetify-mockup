        ...
        <v-card>
            ...
            <v-card-text>
                <v-form class="px-3" ref="form">
                    ...
                    <v-menu>
                        <v-text-field :value="formattedDate" clearable slot="activator" label="Due date" :rules="inputRules" prepend-icon="date_range"></v-text-field>
...
export default {
    ...
    computed: {
        formattedDate() {
            return this.due ? format(this.due, 'Do MMM YYYY') : format(new Date(), 'Do MMM YYYY')
        }
    }
}
</script>
